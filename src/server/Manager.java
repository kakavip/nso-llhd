...
public class Manager {
    ...
    public String[] NinjaS = new String[] { "Chưa vào lớp", "Ninja Kiếm", "Ninja Phi Tiêu", "Ninja Kinai", "Ninja Cung",
    ...
    private void loadConfigFile() {
        ...
        if (configMap.containsKey("mysql-port")) {
            mysql_port = configMap.get("mysql-port");
        } else {
            mysql_port = "3307";
        }
    ...
    private void loadDataBase() {
        SQLManager.create(mysql_host, Integer.parseInt(mysql_port), mysql_database, mysql_user, mysql_pass);
        int i = 0;
        ResultSet res;
        try {
            ...
            while (res.next()) {
                ...
                for (int j = 0; j < Option.size(); j++) {
                    ...
                    Option option = new Option(Integer.parseInt(job.get("id").toString()),
                            Integer.parseInt(job.get("param").toString()));
            ...
            while (res.next()) {
                ...
                for (Object template : Skilltemplate) {
                    ...
                    for (Object option : Option) {
                        ...
                        Option op = new Option(Integer.parseInt(job2.get("id").toString()),
    ...
    public void sendData(Player p) throws IOException {
        ...
        m.writer().writeByte(vsData);// phien ban data
