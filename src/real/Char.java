...
/* 736 */         sqlSET = sqlSET + ",`clan`='" + jarr.toJSONString() + "',`denbu`=" + this.denbu + ",`newlogin`='" + util.toDateString(this.newlogin) + "',`ddClan`=" + this.ddClan + ",`caveID`="+caveID+",`nCave`="+nCave+",`pointCave`="+pointCave+",`useCave`="+useCave+",`bagCaveMax`="+bagCaveMax+",`itemIDCaveMax`="+itemIDCaveMax+",`exptype`="+exptype+"";
